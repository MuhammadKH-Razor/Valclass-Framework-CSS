    ...
    if (document.querySelector('ul')) {
        for (var i = 0; i < propertiesPerspective.length; i++) {
            for (var a = 0; a < document.querySelectorAll('ul').length; a++) {
                if (document.querySelectorAll('ul')[a].classList.contains(propertiesPerspective[i]) && !document.querySelector('style').innerText.includes(propertiesPerspective[i])) {
    ...
    if (document.querySelector('li')) {
        for (var i = 0; i < propertiesPerspective.length; i++) {
            for (var a = 0; a < document.querySelectorAll('li').length; a++) {
                if (document.querySelectorAll('li')[a].classList.contains(propertiesPerspective[i]) && !document.querySelector('style').innerText.includes(propertiesPerspective[i])) {
