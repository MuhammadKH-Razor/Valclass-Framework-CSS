    ...
    if (document.querySelector('ul')) {
        for (var i = 0; i < propertiesMargins.length; i++) {
            for (var a = 0; a < document.querySelectorAll('ul').length; a++) {
                if (document.querySelectorAll('ul')[a].classList.contains(propertiesMargins[i]) && !document.querySelector('style').innerText.includes(propertiesMargins[i])) {
    ...
    if (document.querySelector('li')) {
        for (var i = 0; i < propertiesMargins.length; i++) {
            for (var a = 0; a < document.querySelectorAll('li').length; a++) {
                if (document.querySelectorAll('li')[a].classList.contains(propertiesMargins[i]) && !document.querySelector('style').innerText.includes(propertiesMargins[i])) {
